...
//									0.1903));
			...
			//											sensorFusion.h, sensorFusion.p, sensorFusion.b, sensorFusion.xlinear, sensorFusion.ylinear, sensorFusion.zlinear,
			//											sensorFusion.xrotate, sensorFusion.yrotate, sensorFusion.zrotate, sensorFusion.pressure,
			//											sensorFusion.temperature, sensorFusion.humidity);
		}
